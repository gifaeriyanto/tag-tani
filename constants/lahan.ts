...
export const LAHAN_LIST: Lahan[] = [
  {
    id: 'lhn-001',
    name: 'Sawah Timur A',
    kelompokTaniId: 'kt-001',
    kelompokTaniName: 'Sumber Rezeki',
    petaniId: 'ptn-001',
    petaniName: 'Ahmad Dahlan',
    coordinates: [
      [-4.0123, 120.0145],
      [-4.0123, 120.0178],
      [-4.0145, 120.0178],
  ...
  },
  {
    ...
    kelompokTaniId: 'kt-002',
    kelompokTaniName: 'Harapan Makmur',
    petaniId: 'ptn-005',
    petaniName: 'Rahman Abdullah',
    coordinates: [
      [-3.9980, 120.0200],
      [-3.9980, 120.0235],
      [-4.0005, 120.0238],
  ...
  },
  {
    ...
    kelompokTaniId: 'kt-003',
    kelompokTaniName: 'Tani Jaya',
    petaniId: 'ptn-009',
